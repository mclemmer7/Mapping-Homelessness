...
# Load data
seattle <- read_sf("seattle_erap_red_evic_3.geojson")
...
plot1 <- ggplot(seattle_clean, aes(x = percent_black, y = eviction_rate)) +
...
plot2 <- ggplot(seattle_clean, aes(x = percent_asian, y = eviction_rate)) +
...
plot3 <- ggplot(seattle_clean, aes(x = percent_latine, y = eviction_rate)) +
...
plot4 <- ggplot(seattle_clean, aes(x = percent_other, y = eviction_rate)) +
...
plot8 <- ggplot(seattle_clean, aes(x = index_value, y = eviction_rate)) +
...
plot9 <- ggplot(seattle_clean, aes(x = median.gross.rent, y = eviction_rate)) +
  geom_point(color = "black", alpha = 0.35, shape = 21, stroke = 0.5, fill = "#EBDC49" ) +
