...
# Load data
seattle <- read_sf("seattle_erap_red_evic.geojson")
...
plot1 <- ggplot(seattle_clean, aes(x = percent_black, y = eviction.rate)) +
  geom_point() +
...
plot2 <- ggplot(seattle_clean, aes(x = percent_asian, y = eviction.rate)) +
  geom_point() +
...
plot3 <- ggplot(seattle_clean, aes(x = percent_latine, y = eviction.rate)) +
  geom_point() +
...
plot4 <- ggplot(seattle_clean, aes(x = percent_other, y = eviction.rate)) +
  geom_point() +
...
plot9 <- ggplot(seattle_clean, aes(x = index_value, y = eviction.rate)) +
  geom_point() +
...
plot10 <- ggplot(seattle_clean, aes(x = median.gross.rent, y = eviction.rate)) +
  geom_point() +
...
grid.arrange(
  ...
  top = textGrob("Seattle Graphs", gp = gpar(fontsize = 15, font = 2))
)