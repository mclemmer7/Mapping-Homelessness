...
plot1 <- ggplot(cleveland_clean, aes(x = percent_black, y = eviction.rate)) +
  geom_point() +
...
plot2 <- ggplot(cleveland_clean, aes(x = percent_asian, y = eviction.rate)) +
  geom_point() +
...
plot3 <- ggplot(cleveland_clean, aes(x = percent_latine, y = eviction.rate)) +
  geom_point() +
...
plot4 <- ggplot(cleveland_clean, aes(x = percent_other, y = eviction.rate)) +
  geom_point() +
...
plot9 <- ggplot(cleveland_clean, aes(x = index_value, y = eviction.rate)) +
  geom_point() +
...
plot10 <- ggplot(cleveland_clean, aes(x = median.gross.rent, y = eviction.rate)) +
  geom_point() +
